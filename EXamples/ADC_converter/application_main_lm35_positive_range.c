...
uint_16 LM35_Celsius0 = 0 ,LM35_Celsius1 = 0 ;

uint_8 LM93_Celsius0_text[6] ;
uint_8 LM93_Celsius1_text[6] ;
...
int main() {
  ...
  while(1){
      ...
      LM35_Celsius0 =(uint_16)(LM35_result0*4.88f/10);
      LM35_Celsius1 =(uint_16)(LM35_result1*4.88f/10);
      ...
      ret = convert_uint_16_to_string(LM35_Celsius0 ,LM93_Celsius0_text) ;
      ret = lcd_4bit_send_string_pos(&lcd1 ,3 , 8,LM93_Celsius0_text) ;
      
      ret = convert_uint_16_to_string(LM35_Celsius1 ,LM93_Celsius0_text) ;
