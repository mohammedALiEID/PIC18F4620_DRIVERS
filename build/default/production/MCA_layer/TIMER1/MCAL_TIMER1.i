# 1 "MCA_layer/TIMER1/MCAL_TIMER1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCA_layer/TIMER1/MCAL_TIMER1.c" 2
...
# 1 "MCA_layer/TIMER1/../interrupt/mcal_internal_interrupt.h" 1
# 15 "MCA_layer/TIMER1/../interrupt/mcal_internal_interrupt.h"
# 1 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 1
# 12 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h"
...
# 12 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER1/../interrupt/../std_libraries.h" 1
# 12 "MCA_layer/TIMER1/../interrupt/../std_libraries.h"
...
# 12 "MCA_layer/TIMER1/../interrupt/../std_libraries.h" 2
...
# 13 "MCA_layer/TIMER1/../interrupt/../std_libraries.h" 2
...
# 14 "MCA_layer/TIMER1/../interrupt/../std_libraries.h" 2
# 13 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER1/../interrupt/../mcal_std_types.h" 1
# 14 "MCA_layer/TIMER1/../interrupt/../mcal_std_types.h"
# 1 "MCA_layer/TIMER1/../interrupt/../compiler.h" 1
# 13 "MCA_layer/TIMER1/../interrupt/../compiler.h"
...
# 13 "MCA_layer/TIMER1/../interrupt/../compiler.h" 2
# 14 "MCA_layer/TIMER1/../interrupt/../mcal_std_types.h" 2
# 72 "MCA_layer/TIMER1/../interrupt/../mcal_std_types.h"
...
# 14 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER1/../interrupt/../../MCA_layer/device_configuration/device_configure.h" 1
# 15 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 2


# 1 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_genrator_cfg.h" 1
# 17 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER1/../interrupt/../GPIO/mcal_GPIO.h" 1
# 18 "MCA_layer/TIMER1/../interrupt/../GPIO/mcal_GPIO.h"
# 1 "MCA_layer/TIMER1/../interrupt/../GPIO/mcal_gpio_confg.h" 1
# 18 "MCA_layer/TIMER1/../interrupt/../GPIO/mcal_GPIO.h" 2
...
# 78 "MCA_layer/TIMER1/../interrupt/../GPIO/mcal_GPIO.h"
...
# 18 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h" 2
# 48 "MCA_layer/TIMER1/../interrupt/mcal_interrupt_confg.h"
typedef enum{
   interrupt_low_prioity = 0 ,
   interrupt_HIGH_prioity

}interrupt_priorty_t;
# 15 "MCA_layer/TIMER1/../interrupt/mcal_internal_interrupt.h" 2
# 176 "MCA_layer/TIMER1/../interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void) ;
...
# 14 "MCA_layer/TIMER1/MCAL_TIMER1.h" 2
...
# 8 "MCA_layer/TIMER1/MCAL_TIMER1.c" 2


static __attribute__((inline)) Std_ReturnType TIMER1_MODE_CONFG(const TIMER1_CONFG_t*_timer1) ;
static __attribute__((inline)) Std_ReturnType TIMER1_OSC_CONFG(const TIMER1_CONFG_t*_timer1) ;
...
# 56 "MCA_layer/TIMER1/MCAL_TIMER1.c"
       (INTCONbits.GIE=1) ;
       (INTCONbits.PEIE=1) ;
...
Std_ReturnType TIMER1_READ_VALUE(const TIMER1_CONFG_t*_timer1 , uint_16 *return_value) {
    ...
    uint_8 timer1_L = 0 ;
    uint_8 timer1_H = 0 ;
    if ((((void*)0)==_timer1)||(((void*)0)==return_value)){
...
static __attribute__((inline)) Std_ReturnType TIMER1_MODE_CONFG(const TIMER1_CONFG_t*_timer1) {
    ...
    if (((void*)0)==_timer1){
        ...
        if(_timer1->TIMER1_mode ==0x0){

           (T1CONbits.TMR1CS = 0) ;
        }
        else if (_timer1->TIMER1_mode ==0x1){

           (T1CONbits.TMR1CS = 1) ;
            (TRISC|=((uint_8)1<<0x0)) ;

            if(_timer1->TIMER1_counter_mode==0x1){

              (T1CONbits.T1SYNC =1) ;
            }
            else if (_timer1->TIMER1_counter_mode==0x0){
                (T1CONbits.T1SYNC = 0) ;
            }
...
static __attribute__((inline)) Std_ReturnType TIMER1_OSC_CONFG(const TIMER1_CONFG_t*_timer1) {
    ...
    if (((void*)0)==_timer1){
        ...
        if (_timer1->TIMER1_OSC_status ==0x1 ){


        (T1CONbits.T1OSCEN = 1) ;

        }
        else if (_timer1->TIMER1_OSC_status ==0x0){
