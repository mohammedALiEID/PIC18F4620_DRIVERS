...
# 2 "<built-in>" 2
# 1 "MCA_layer/GPIO/mcal_GPIO.c" 2
...
# 1 "MCA_layer/GPIO/mcal_GPIO.h" 1
# 15 "MCA_layer/GPIO/mcal_GPIO.h"
...
# 15 "MCA_layer/GPIO/mcal_GPIO.h" 2

# 1 "MCA_layer/GPIO/../mcal_std_types.h" 1
# 13 "MCA_layer/GPIO/../mcal_std_types.h"
# 1 "MCA_layer/GPIO/../std_libraries.h" 1
# 12 "MCA_layer/GPIO/../std_libraries.h"
...
# 12 "MCA_layer/GPIO/../std_libraries.h" 2
...
# 13 "MCA_layer/GPIO/../std_libraries.h" 2
...
# 14 "MCA_layer/GPIO/../std_libraries.h" 2
# 13 "MCA_layer/GPIO/../mcal_std_types.h" 2

# 1 "MCA_layer/GPIO/../compiler.h" 1
# 13 "MCA_layer/GPIO/../compiler.h"
...
# 13 "MCA_layer/GPIO/../compiler.h" 2
# 14 "MCA_layer/GPIO/../mcal_std_types.h" 2
# 72 "MCA_layer/GPIO/../mcal_std_types.h"
...
# 16 "MCA_layer/GPIO/mcal_GPIO.h" 2

# 1 "MCA_layer/GPIO/../../MCA_layer/device_configuration/device_configure.h" 1
# 17 "MCA_layer/GPIO/mcal_GPIO.h" 2

# 1 "MCA_layer/GPIO/mcal_gpio_confg.h" 1
# 18 "MCA_layer/GPIO/mcal_GPIO.h" 2
...
# 8 "MCA_layer/GPIO/mcal_GPIO.c" 2



volatile uint_8*tris_regisrers[5]= {&TRISA ,&TRISB ,&TRISC ,&TRISD ,&TRISE };
volatile uint_8*port_regisrers[5]= {&PORTA ,&PORTB ,&PORTC ,&PORTD ,&PORTE };
volatile uint_8*lat_regisrers[5]= {&LATA ,&LATB ,&LATC ,&LATD ,&LATE };
# 22 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_pin_direction_initalize(const pin_confg_t *pin_confg ) {
    Std_ReturnType ret = (Std_ReturnType)0x1 ;

    if ((((void*)0)==pin_confg )||(pin_confg->port > 5 -1) || (pin_confg->pin >8 -1))
        ret = (Std_ReturnType)0x0 ;
    else {
        switch (pin_confg->direction){
            case OUTPUT :

                (*tris_regisrers[pin_confg->port]&=~((uint_8)1<<pin_confg->pin)) ;
...
# 67 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_pin_get_direction_status(const pin_confg_t *pin_confg ,direction_t *direction_status) {
       Std_ReturnType ret = (Std_ReturnType)0x1 ;

    if ((((void*)0)==pin_confg )||(pin_confg->port > 5 -1) || (pin_confg->pin >8 -1)||(((void*)0)==direction_status))
        ret = (Std_ReturnType)0x0 ;
    else {

        *direction_status = ((*tris_regisrers[pin_confg->port]>>pin_confg->pin)&(uint_8)1 ) ;
    ...
    if ((((void*)0)==pin_confg )||(pin_confg->port > 5 -1) || (pin_confg->pin >8 -1))
        ...
        switch (logic){
            case LOW :
                ...
                (*lat_regisrers[pin_confg->port]&=~((uint_8)1<<pin_confg->pin)) ;
...
# 140 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_pin_read_logic(const pin_confg_t *pin_confg ,logic_t* logic) {
      Std_ReturnType ret = (Std_ReturnType)0x1 ;

    if ((((void*)0)==pin_confg )||(pin_confg->port > 5 -1) || (pin_confg->pin >8 -1)||(((void*)0)==logic))
        ret = (Std_ReturnType)0x0 ;
    else {

         *logic = ((*port_regisrers[pin_confg->port]>>pin_confg->pin)&(uint_8)1 ) ;
...
# 164 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_confg_t *pin_confg ) {
     Std_ReturnType ret = (Std_ReturnType)0x1 ;
...
# 188 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_pin__ALL_initaliztion(const pin_confg_t *pin_confg ) {
      Std_ReturnType ret = (Std_ReturnType)0x1 ;
...
# 214 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_port_direction_initalize(port_index_t port ,uint_8 direction ) {
     Std_ReturnType ret = (Std_ReturnType)0x1 ;
    if (port > (5 -1)){
...
# 239 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_port_get_direction_status(port_index_t port ,uint_8 *direction_status) {
      Std_ReturnType ret = (Std_ReturnType)0x1 ;
...
# 265 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_port_write_logic( port_index_t port ,uint_8 logic) {
...
# 292 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_port_read_logic(port_index_t port ,uint_8* logic) {
      Std_ReturnType ret = (Std_ReturnType)0x1 ;
...
# 319 "MCA_layer/GPIO/mcal_GPIO.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port ) {
     Std_ReturnType ret = (Std_ReturnType)0x1 ;
    if (port > (5 -1)){
