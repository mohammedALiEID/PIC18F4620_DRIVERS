# 1 "MCA_layer/TIMER0/MCAL_TIMER0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCA_layer/TIMER0/MCAL_TIMER0.c" 2
...
# 1 "MCA_layer/TIMER0/../interrupt/mcal_internal_interrupt.h" 1
# 15 "MCA_layer/TIMER0/../interrupt/mcal_internal_interrupt.h"
# 1 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 1
# 12 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h"
...
# 12 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER0/../interrupt/../std_libraries.h" 1
# 12 "MCA_layer/TIMER0/../interrupt/../std_libraries.h"
...
# 12 "MCA_layer/TIMER0/../interrupt/../std_libraries.h" 2
...
# 13 "MCA_layer/TIMER0/../interrupt/../std_libraries.h" 2
...
# 14 "MCA_layer/TIMER0/../interrupt/../std_libraries.h" 2
# 13 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER0/../interrupt/../mcal_std_types.h" 1
# 14 "MCA_layer/TIMER0/../interrupt/../mcal_std_types.h"
# 1 "MCA_layer/TIMER0/../interrupt/../compiler.h" 1
# 13 "MCA_layer/TIMER0/../interrupt/../compiler.h"
...
# 13 "MCA_layer/TIMER0/../interrupt/../compiler.h" 2
# 14 "MCA_layer/TIMER0/../interrupt/../mcal_std_types.h" 2
# 72 "MCA_layer/TIMER0/../interrupt/../mcal_std_types.h"
...
# 14 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER0/../interrupt/../../MCA_layer/device_configuration/device_configure.h" 1
# 15 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 2


# 1 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_genrator_cfg.h" 1
# 17 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 2

# 1 "MCA_layer/TIMER0/../interrupt/../GPIO/mcal_GPIO.h" 1
# 18 "MCA_layer/TIMER0/../interrupt/../GPIO/mcal_GPIO.h"
# 1 "MCA_layer/TIMER0/../interrupt/../GPIO/mcal_gpio_confg.h" 1
# 18 "MCA_layer/TIMER0/../interrupt/../GPIO/mcal_GPIO.h" 2
...
# 78 "MCA_layer/TIMER0/../interrupt/../GPIO/mcal_GPIO.h"
...
# 18 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h" 2
# 48 "MCA_layer/TIMER0/../interrupt/mcal_interrupt_confg.h"
typedef enum{
   interrupt_low_prioity = 0 ,
   interrupt_HIGH_prioity

}interrupt_priorty_t;
# 15 "MCA_layer/TIMER0/../interrupt/mcal_internal_interrupt.h" 2
# 176 "MCA_layer/TIMER0/../interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void) ;
...
# 13 "MCA_layer/TIMER0/MCAL_TIMER0.h" 2
...
# 8 "MCA_layer/TIMER0/MCAL_TIMER0.c" 2


static __attribute__((inline)) Std_ReturnType TIMER0_prescaler_CONFG(const TIMER0_CONFG_t*_timer0) ;
static __attribute__((inline)) Std_ReturnType TIMER0_MODE_CONFG(const TIMER0_CONFG_t*_timer0) ;
static __attribute__((inline)) Std_ReturnType TIMER0_register_size_CONFG(const TIMER0_CONFG_t*_timer0) ;

static void(*TIMER0_INTERRUPT_HANDLER)(void) =((void*)0) ;

static uint_16 Timer0_preloaded_value = 0 ;
# 26 "MCA_layer/TIMER0/MCAL_TIMER0.c"
Std_ReturnType TIMER0_INITIALIZE(const TIMER0_CONFG_t*_timer0 ) {
...
# 60 "MCA_layer/TIMER0/MCAL_TIMER0.c"
       (INTCONbits.GIE=1) ;
       (INTCONbits.PEIE=1) ;
...
Std_ReturnType TIMER0_READ_VALUE(const TIMER0_CONFG_t*_timer0 , uint_16 *return_value) {
    ...
    uint_8 timer0_L = 0 ;
    uint_8 timer0_H = 0 ;
    if ((((void*)0)==_timer0)||(((void*)0)==return_value)){
...
static __attribute__((inline)) Std_ReturnType TIMER0_prescaler_CONFG(const TIMER0_CONFG_t*_timer0) {
    ...
    if (((void*)0)==_timer0){
        ...
        if (0x1==_timer0->TIMER0_prescaler_status){

           (T0CONbits.PSA = 1) ;
        }
        else if (0x0==_timer0->TIMER0_prescaler_status){

             (T0CONbits.PSA = 0) ;
        T0CONbits.T0PS =_timer0->TIMER0_prescaler_value ;
        }
        else {ret=(Std_ReturnType)0x0 ;}
...
static __attribute__((inline)) Std_ReturnType TIMER0_MODE_CONFG(const TIMER0_CONFG_t*_timer0) {
    ...
    if (((void*)0)==_timer0){
        ...
        if(_timer0->TIMER0_mode ==0x0){

           (T0CONbits.T0CS = 0) ;
        }
        else if (_timer0->TIMER0_mode ==0x1){

            (T0CONbits.T0CS = 1) ;
            (TRISA|=((uint_8)1<<0x4)) ;
            if(_timer0->TIMER0_COUNTER_Edge==0x1){

                (T0CONbits.T0SE = 1) ;
            }
            else if (_timer0->TIMER0_COUNTER_Edge==0x0){
                (T0CONbits.T0SE = 0) ;
            }
            else {ret=(Std_ReturnType)0x0 ;}
...
static __attribute__((inline)) Std_ReturnType TIMER0_register_size_CONFG(const TIMER0_CONFG_t*_timer0) {
    ...
    if (((void*)0)==_timer0){
        ...
        if (0x1==_timer0->TIMER0_register_size){

            (T0CONbits.T08BIT = 1) ;
        }
        else if (0x0==_timer0->TIMER0_register_size){
