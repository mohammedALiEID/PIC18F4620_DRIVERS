...
# 13 "MCA_layer/ADC/MCAL_ADC.h" 2

# 1 "MCA_layer/ADC/../mcal_std_types.h" 1
# 13 "MCA_layer/ADC/../mcal_std_types.h"
# 1 "MCA_layer/ADC/../std_libraries.h" 1
# 12 "MCA_layer/ADC/../std_libraries.h"
...
# 12 "MCA_layer/ADC/../std_libraries.h" 2
...
# 13 "MCA_layer/ADC/../std_libraries.h" 2
...
# 14 "MCA_layer/ADC/../std_libraries.h" 2
# 13 "MCA_layer/ADC/../mcal_std_types.h" 2

# 1 "MCA_layer/ADC/../compiler.h" 1
# 13 "MCA_layer/ADC/../compiler.h"
...
# 13 "MCA_layer/ADC/../compiler.h" 2
# 14 "MCA_layer/ADC/../mcal_std_types.h" 2
# 72 "MCA_layer/ADC/../mcal_std_types.h"
...
# 14 "MCA_layer/ADC/MCAL_ADC.h" 2

# 1 "MCA_layer/ADC/../GPIO/mcal_GPIO.h" 1
# 17 "MCA_layer/ADC/../GPIO/mcal_GPIO.h"
# 1 "MCA_layer/ADC/../GPIO/../../MCA_layer/device_configuration/device_configure.h" 1
# 17 "MCA_layer/ADC/../GPIO/mcal_GPIO.h" 2

# 1 "MCA_layer/ADC/../GPIO/mcal_gpio_confg.h" 1
# 18 "MCA_layer/ADC/../GPIO/mcal_GPIO.h" 2
...
# 78 "MCA_layer/ADC/../GPIO/mcal_GPIO.h"
...
# 15 "MCA_layer/ADC/MCAL_ADC.h" 2

# 1 "MCA_layer/ADC/../interrupt/mcal_internal_interrupt.h" 1
# 15 "MCA_layer/ADC/../interrupt/mcal_internal_interrupt.h"
# 1 "MCA_layer/ADC/../interrupt/mcal_interrupt_confg.h" 1
# 17 "MCA_layer/ADC/../interrupt/mcal_interrupt_confg.h"
# 1 "MCA_layer/ADC/../interrupt/mcal_interrupt_genrator_cfg.h" 1
# 17 "MCA_layer/ADC/../interrupt/mcal_interrupt_confg.h" 2
# 48 "MCA_layer/ADC/../interrupt/mcal_interrupt_confg.h"
typedef enum{
   interrupt_low_prioity = 0 ,
   interrupt_HIGH_prioity

}interrupt_priorty_t;
# 15 "MCA_layer/ADC/../interrupt/mcal_internal_interrupt.h" 2
...
# 8 "MCA_layer/ADC/MCAL_ADC.c" 2


static __attribute__((inline)) void ADC_configure_channel_as_input(ADC_channel_select_t channel) ;
static __attribute__((inline)) void ADC_configure_voltage_ref(const ADC_confg_t*_ADC) ;
static __attribute__((inline)) void ADC_configure_result_format(const ADC_confg_t*_ADC);

static void (*ADC_INTERRUPT_HANDLER)(void)=((void*)0) ;
# 25 "MCA_layer/ADC/MCAL_ADC.c"
Std_ReturnType ADC_init(const ADC_confg_t*_ADC){
    ...
    if (((void*)0)==_ADC){
        ...
        (ADCON1bits.PCFG =(_ADC->A_D_port_confg)) ;
# 66 "MCA_layer/ADC/MCAL_ADC.c"
        (ADCON0bits.ADON = 1) ;
...
Std_ReturnType ADC_Get_conversionStatus(const ADC_confg_t*_ADC ,conversion_status_t *conversion_status) {
    ...
    if ((((void*)0)==_ADC)||(((void*)0)==conversion_status)){
        ...
        *conversion_status = (conversion_status_t)(!((ADCON0bits.GO_nDONE ))) ;
...
Std_ReturnType ADC_Get_conversionRsult(const ADC_confg_t*_ADC ,uint_16 *conversion_result) {
   Std_ReturnType ret =(Std_ReturnType)0x1 ;
    if ((((void*)0)==_ADC)||(((void*)0)==conversion_result)){
        ...
        if (_ADC->result_format == 0x1U){

            *conversion_result = (uint_16)((ADRESH<<8)|(ADRESL)) ;

    }

    else if (_ADC->result_format == 0x0U){
...
static __attribute__((inline)) void ADC_configure_channel_as_input(ADC_channel_select_t channel) {
    ...
    switch(channel){
        ...
        case ADC_CHANNEL_AN0 :(TRISA|=((uint_8)1<<0x0)) ;break ;
        case ADC_CHANNEL_AN1 :(TRISA|=((uint_8)1<<0x1)) ;break ;
        case ADC_CHANNEL_AN2 :(TRISA|=((uint_8)1<<0x2)) ;break ;
        case ADC_CHANNEL_AN3 :(TRISA|=((uint_8)1<<0x3)) ;break ;
        case ADC_CHANNEL_AN4 :(TRISA|=((uint_8)1<<0x5)) ;break ;
        case ADC_CHANNEL_AN5 :(TRISE|=((uint_8)1<<0x0)) ;break ;
        case ADC_CHANNEL_AN6 :(TRISE|=((uint_8)1<<0x1)) ;break ;
        case ADC_CHANNEL_AN7 :(TRISE|=((uint_8)1<<0x2)) ;break ;
        case ADC_CHANNEL_AN8 :(TRISB|=((uint_8)1<<0x2)) ;break ;
        case ADC_CHANNEL_AN9 :(TRISB|=((uint_8)1<<0x3)) ;break ;
        case ADC_CHANNEL_AN10 :(TRISB|=((uint_8)1<<0x1)) ;break ;
        case ADC_CHANNEL_AN11 :(TRISB|=((uint_8)1<<0x4)) ;break ;
        case ADC_CHANNEL_AN12 :(TRISB|=((uint_8)1<<0x0)) ;break ;
...
static __attribute__((inline)) void ADC_configure_voltage_ref(const ADC_confg_t*_ADC){
    ...
    if (_ADC->voltage_ref == 0x1U){

        do{ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG1 = 1 ; }while(0) ;
    }

    else if (_ADC->voltage_ref == 0x0U){
