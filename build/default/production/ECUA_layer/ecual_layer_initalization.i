# 1 "ECUA_layer/ecual_layer_initalization.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECUA_layer/ecual_layer_initalization.c" 2
...
# 9 "ECUA_layer/ecual_layer_initalization.c" 2
...
# 98 "ECUA_layer/ecual_layer_initalization.c"
void ECUAL_peripherals_initialization(void){
